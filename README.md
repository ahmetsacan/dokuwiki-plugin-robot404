...
Disallowed actions will produce 404 code (page not found) when the user agent is detected to be a robot. Actions that are disabled in dokuwiki normally just display a message; webcrawlers will still index the resulting page and also visit these pages again in the future. 
